...
#    Updated: 2025/03/18 17:31:28 by icunha-t         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC_PATH = ./src/
SRC = $(addprefix $(SRC_PATH), ./00_main/00_constructors.c ./00_main/01_main.c ./10_init/10_msh_init.c ./10_init/11_init_utils.c ./20_syntax/20_syntax_check.c ./30_tokens/30_tokenizer.c ./30_tokens/31_token_type_p1.c ./30_tokens/32_token_type_p2.c 10_close_msh.c)
OBJ = $(SRC:.c=.o)
